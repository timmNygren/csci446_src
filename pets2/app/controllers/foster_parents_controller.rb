  ...
  def create
    ...
    respond_to do |format|
      if @foster_parent.save
        @pet = Pet.find_by(id: @foster_parent.pet_id)
        @pet.status = "Fostered"
        @pet.save!
        format.html { redirect_to fosterhome_url, notice: 'Congratulations! You have fostered a new pet.' }
